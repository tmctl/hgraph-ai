      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Transform natural language questions about Hedera accounts, 
            NFTs, and smart contracts into beautiful graphs and actionable insights.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto animate-slide-up">
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 shadow-soft hover:shadow-medium transition-all duration-300">
              ...
              <p className="text-muted-foreground">Ask questions in plain English about blockchain data</p>
            </div>
