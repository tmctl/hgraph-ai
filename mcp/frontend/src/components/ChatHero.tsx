...
- "transactions I sent" refers to transactions from account ${accountId}`;
    ...
    try {
      const { response: responseText, metadata } =
        await sendMessageWithMetadata(currentQuestion, systemPrompt, accountId || undefined);
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='text-center mb-8 animate-fade-in'>
            ...
            <p className='text-xl md:text-2xl text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed'>
              Transform natural language questions about Hedera blockchain into
            ...
            <div className='flex items-center justify-center gap-2 mb-8'>
              ...
              <span className='text-accent font-medium'>
                Powered by Hgraph’s MCP Server
              </span>
            </div>
          </div>
